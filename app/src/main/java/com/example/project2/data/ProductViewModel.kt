...
class ProductViewModel(var navController: NavController, var context: Context) {
    ...
    fun saveProduct(paymentmethod:String,destination:String,arrival_time:String,cutlery:String,id:String) {
        var id = System.currentTimeMillis().toString()
        var productData = MyBookings(paymentmethod,destination,arrival_time,cutlery,id)
    ...
    fun viewProducts(
        product: MutableState<Any>,
        products: MutableState<Any>
    ): MutableState<Any> {
    ...
    fun deleteProduct(id: String) {
        ...
        delRef.removeValue().addOnCompleteListener {
            ...
            if (it.isSuccessful) {
                ...
                navController.navigate(ROUTE_UPDATEPAYMENT)
            }
        }
    }

    fun updateProduct(paymentmethod: String, destination: String, arrivaltime: String,cutlurey:String ,id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = MyBookings(paymentmethod, destination, arrivaltime,cutlurey ,id)
...
private fun <T> MutableState<T>.add(value: T) {

}
private fun <T> MutableState<T>.clear(value: T) {
