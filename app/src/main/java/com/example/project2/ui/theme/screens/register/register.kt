package com.example.project2.ui.theme.screens.register
...
fun RegisterScreen(navController: NavController){
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Image(painter = painterResource(id = R.drawable.screens), contentDescription = "background image",
...
//        horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        Button(onClick = {
            ...
            colors = ButtonDefaults.buttonColors(Color(0xFFEFB8C8))) {
            Text(text = "Sign Up")
        }
